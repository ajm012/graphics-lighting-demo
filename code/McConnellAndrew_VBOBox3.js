...
VBObox3.prototype.init = function(myGL) {
    ...
    if(!this.uLoc_Ke1 || !this.uLoc_Ka1 || !this.uLoc_Kd1  || !this.uLoc_Ks1 || !this.uLoc_Kshiny1) {console.log('Failed to get GPUs Reflectance storage locations');return;}
